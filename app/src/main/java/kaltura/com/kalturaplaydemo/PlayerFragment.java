...
public class PlayerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        KPPlayerConfig config = new  KPPlayerConfig("http://cdnapi.kaltura.com/html5/html5lib/v2.32/mwEmbedFrame.php", "30743062", "kaltura_player");
        config.setWid("_1988382");
        config.setCacheSt("1402219661");
